                                    ...
                                    <div class="invoice-head">
                                        <div class="row">
                                            <div class="iv-left col-6">
                                                <span>Laporan Pengeluaran Salt Nusantara</span>
                                            </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="invoice-address">
                                                <h3>Laporan Pengeluaran Salt Nusantara</h3>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-bordered table-hover text-right">
                                            <thead>
                                                <tr class="text-capitalize">
                                                    ...
                                                    <th class="text-left" style="width: 45%; min-width: 130px;">Date Spending</th>
